...
def init_param():
    ...
    file_name = "/homecentral/alexandre.mahrach/IDIBAPS/cpp/rate_model/parameters/%dpop/%s.txt" % (gv.n_pop, gv.folder)
    ...
    with open(file_name, 'r') as file:  # Open file for read
        ...
        path = '/homecentral/alexandre.mahrach/IDIBAPS/cpp/rate_model/simulations/%dpop/%s/N%d/K%d/' %( gv.n_pop, gv.folder, gv.n_neurons, gv.K) 
